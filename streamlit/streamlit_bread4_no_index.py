...
def cluster_0():
    ...
    df_mode = pd.read_csv('streamlit/streamlit_mode.csv')
...
def cluster_0_store0():
    ...
    df_text = pd.read_csv('streamlit/streamlit_text.csv')
    ...
    with col2:
        ...
        st.dataframe(good_review_text, hide_index=True)
        ...
        st.dataframe(bad_review_text, hide_index=True)
...
def cluster_4_store0():
    ...
    with col2:
        ...
        st.dataframe(review_text, hide_index=True)
